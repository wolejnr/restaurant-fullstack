                                ...
                                <div class="card-body">
                                    <form method="POST" action="/admin/users/{{$user->id}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="inputFirstName" type="text" class="form-control form-control-lg @error('fname') is-invalid @enderror" name="fname" value="{{ old('fname', $user->fname) }}" required autocomplete="name" placeholder="First Name" autofocus>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="inputLastName" type="text" class="form-control form-control-lg @error('lname') is-invalid @enderror" name="lname" value="{{ old('lname', $user->lname) }}" required autocomplete="name" placeholder="Last Name" autofocus>
